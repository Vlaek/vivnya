...
- Recreate the first Product Design concept, “Night Archive”.
- Use a near-black canvas, warm-white oversized `VIVNYA` typography, and one muted-magenta accent.
- Milana Zubareva's supplied ArtStation artwork is the dominant visual material; do not generate replacement artwork or invent portfolio projects.
